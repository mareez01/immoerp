      ...
      <DialogContent className="sm:max-w-[450px]">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            {/* Customer Badge */}
            <div className="px-3 py-1 rounded-full text-sm font-medium border bg-blue-500/10 text-blue-600 border-blue-200">
              Customer
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {isEditing ? (
                ...
                <p className="px-3 py-2 bg-muted/50 rounded-md text-sm">{user?.full_name || '—'}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {isEditing ? (
                ...
                <p className="px-3 py-2 bg-muted/50 rounded-md text-sm">{user?.company_name || '—'}</p>
              )}
            </div>
          </div>
        </div>
